...
class AccessibilityAppsPreset(private val presetManager: PresetManager) : BasePreset(NAME) {
    companion object {
        ...
        // UTF-16LE encoded "android.permission.BIND_ACCESSIBILITY_SERVICE" with
        // null bytes between ASCII chars, matching the raw binary AXML format
        // read via US_ASCII in PresetManager.readManifest.
